...
public class GarageWorkOrderServiceImpl implements GarageWorkOrderService {
    ...
    @Override
    public List<GarageWorkOrderResponse> getGarageWorkOrdersByClaimNo(String claimNo, String createdBy) {
	...
	public List<GarageWorkOrderResponse> getAllGarageWorkOrders(String createdBy) {
		List<GarageWorkOrderResponse> res = new ArrayList<>();
        try {
			List<GarageWorkOrder> data = garageWorkOrderRepository.findByCreatedBy(createdBy);
